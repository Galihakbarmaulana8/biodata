...
class PesertadidikR extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pesertadidik.index')->with('succes', 'Peserta Didik Berhasil Ditambahkan');
    }
    ...
    public function update(Request $request, $id)
    {
        $request->validate([
         ...
         return redirect()->route('pesertadidik.index')->with('succes', 'Peserta Didik Berhasil Diperbaharui');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('pesertadidik.index')->with('succes', 'Peserta Didik Berhasil Dihapus');
    }
